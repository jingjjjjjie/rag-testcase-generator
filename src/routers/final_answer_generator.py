...
class FinalAnswerGenerator:
    def __init__(self):
        ...
        # mandatory variables to be defined in .env file
    ...
    def run(self):
        ...
        if os.path.exists(self.FINAL_ANSWER_GENERATOR_OUTPUT_PATH):
            ...
            print(f"Loaded final answer generator {len(inputs)} examples from {os.path.relpath(self.FINAL_ANSWER_GENERATOR_OUTPUT_PATH, PROJECT_ROOT)}.")
        else:
            inputs = load_json(self.FINAL_ANSWER_GENERATOR_INPUT_PATH)
            print(f"Loaded final answer generator {len(inputs)} examples from {os.path.relpath(self.FINAL_ANSWER_GENERATOR_INPUT_PATH, PROJECT_ROOT)}.")
        ...
        print(f"Loaded corpus with {len(corpus_data)} examples from {os.path.relpath(self.FINAL_ANSWER_GENERATOR_CORPUS_PATH, PROJECT_ROOT)}.")
